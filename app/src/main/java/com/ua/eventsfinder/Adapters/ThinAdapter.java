...
public class ThinAdapter extends RecyclerView.Adapter<ThinAdapter.MyViewHolder> {
    private Context context;
    private final ArrayList<Object> lista;

    public ThinAdapter(Context context, ArrayList<Object> lista_) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate((R.layout.thin_view_for_recycler_view),parent,false);
        return new ThinAdapter.MyViewHolder(view);
    }
    ...
    private void handleLocation(ThinAdapter.MyViewHolder holder, MetroArea location){
...
//        holder.imageView.setMaxHeight(130);
    ...
    private void  handleEvent(ThinAdapter.MyViewHolder holder, Event evento){
